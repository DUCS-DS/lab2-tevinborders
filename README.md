...
* the big-O worst-case complexity of the function **search** is N
  ```python
  def search(lst, key):
...
I would not use the function **search** in real life because in an unsorted list the function wouldn't work well.
